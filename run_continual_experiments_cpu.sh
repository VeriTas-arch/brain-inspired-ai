...
# Run 4 continual learning experiments in parallel on CPU ONLY:
#   - DQN without EWC
#   - DQN with EWC
#   - PPO without EWC
#   - PPO with EWC
...
#   cd Atari_Playground
#   nohup ./run_continual_experiments_cpu.sh > continual_master_cpu.log 2>&1 &
#
...
echo "  - ${LOG_DIR}/continual_dqn_no_ewc.log"
echo "  - ${LOG_DIR}/continual_dqn_ewc.log"
echo "  - ${LOG_DIR}/continual_ppo_no_ewc.log"
echo "  - ${LOG_DIR}/continual_ppo_ewc.log"
echo ""
