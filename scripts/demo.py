...
def demo_basic_usage():
    ...
    print("   ✓ Collected 100 experiences for DQN")
    ...
    print("\nNext steps:")
    print("1. Train on one game: python scripts/train_single.py")
    print("2. Train continually: python scripts/train_continual.py")
    print("3. Check README.md for experiment and evaluation commands")
