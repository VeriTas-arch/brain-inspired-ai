...
from biai.atari.training.results import file_digest, result_directory
...
def build_videos(run: Path = TEACHING_RESULTS):
    ...
    from biai.atari.scripts.evaluate import _record_example_video, _set_agent_eval
    from biai.atari.training import configure_ppo_runtime, seed_everything
